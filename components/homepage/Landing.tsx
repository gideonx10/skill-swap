    ...
    <div className="h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 text-gray-900 overflow-hidden">
      ...
      <nav className="relative z-10 flex justify-between items-center px-8 py-6">
        <div className="flex items-center space-x-3">
          ...
          <span className="text-2xl font-black tracking-tighter bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent font-display">SKILLSWAP</span>
        </div>
        <div className="flex items-center space-x-8">
          <a href="#" className="text-gray-700 hover:text-indigo-600 transition-colors font-semibold font-display">Features</a>
          <a href="#" className="text-gray-700 hover:text-indigo-600 transition-colors font-semibold font-display">Pricing</a>
          <a href="#" className="text-gray-700 hover:text-indigo-600 transition-colors font-semibold font-display">About</a>
        ...
        <div className="col-span-12 lg:col-span-7 flex flex-col justify-center space-y-8">
          <div className="space-y-6">
            ...
            <div className="inline-flex items-center px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full shadow-lg border border-indigo-100">
              ...
              <span className="text-sm font-bold text-indigo-800 font-display">Next-Gen Skill Exchange</span>
            </div>
            ...
            <h1 className="pt-5 pb-5 text-[3rem] sm:text-[3.5rem] md:text-[4rem] lg:text-[4.5rem] xl:text-[5rem] font-black tracking-[-0.03em] text-gray-900 leading-[0.9] transform scale-y-120 font-display">
              ...
              <span className="block bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">SKILLS</span>
              <span className="block">GLOBALLY</span>
            </h1>

            {/* Subtitle */}
            <p className="text-xl text-gray-600 max-w-2xl font-medium leading-relaxed font-sans">
              Connect with skilled professionals worldwide. Trade your expertise, learn new skills, and build meaningful professional relationships.
            </p>
          </div>
          ...
          <div className="flex items-center space-x-8 pt-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm font-semibold text-gray-600 font-display">10K+ Active Users</span>
            </div>
            <div className="flex items-center space-x-1">
              <Star className="w-4 h-4 text-yellow-400 fill-current" />
              <span className="text-sm font-bold text-gray-900 font-display">4.9</span>
              <span className="text-sm text-gray-600 font-display">(2.1k reviews)</span>
            </div>
          </div>
        </div>
          ...
          <div className="bg-gradient-to-r from-indigo-500 to-purple-600 p-6 rounded-2xl shadow-xl text-white">
            <div className="grid grid-cols-3 gap-4 text-center">
              <div>
                ...
                <div className="text-xs opacity-90 font-sans">Skills Traded</div>
              </div>
              <div>
